<%@ Page Title="" Language="C#" MasterPageFile="~/Job_Provider_Master_Page.Master" AutoEventWireup="true" CodeBehind="Job_Provider_Change_password.aspx.cs" Inherits="DesignMaster.Job_Provider_Change_password" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Website_Forms" runat="server">
    ...
    <table cellspacing="5px" cellpadding="5px">
        <tr>
            <td colspan="2" style="text-align:center"><h3>Change Your Password</h3></td>
        </tr>
        <tr>
            <td>Old Password:</td>
