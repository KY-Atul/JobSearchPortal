...
{
    public partial class Job_Provider_Change_password : System.Web.UI.Page
    {
        ...
        public void change_password()
        {
            if (txt_confirm_password.Text == txt_new_password.Text && txt_confirm_password.Text != "" && txt_new_password.Text != "" && txt_old_password.Text != "")
            {
                ...
                cmd.Parameters.AddWithValue("@operation_tbl_Company_register", "change_password");
                ...
                cmd.Parameters.AddWithValue("@company_id", Session["Logged_in_Company_ID"]);
                cmd.ExecuteNonQuery();
                cnn.Close();
